...
public class SystemProperties {
	...
	public ShowState checkProperties(ITrafficLight trafficLight)
	{
		...
		case TrafficLightsOnly :
			return  (trafficLight.getLightColor() == TrafficLight.Color.None) ? ShowState.No
					: ShowState.Yes;
		case None:
			return ShowState.No;
		case Green:
			return (trafficLight.getLightColor() == TrafficLight.Color.Green) ? ShowState.Yes
					: ShowState.No;
		case Red:
			return (trafficLight.getLightColor() == TrafficLight.Color.Red) ? ShowState.Yes
					: ShowState.No;
		default:
			return ShowState.No;
		}
