...
public class TransitionRule extends BaseCarKeeper {
	...
	public void switchLight(TrafficLight.Color color, float position) {
		if (position>0) {
	...
	public void drawMainLight(Renderer.RenderType mode) {
		if (mainLight != null) {
	...
	public void drawWaitLight(Renderer.RenderType mode) {
		if (waitLight != null) {
			if (SimulationSystemManager.getInstance().getSystemProperties().
	...
	public void drawWaitPosition(Renderer.RenderType mode) {
	...
	public void drawRule(Renderer.RenderType mode) {
	...
	private void drawLight(ITrafficLight light, Renderer.RenderType mode) {
		if (SimulationSystemManager.getInstance().getSystemProperties().
