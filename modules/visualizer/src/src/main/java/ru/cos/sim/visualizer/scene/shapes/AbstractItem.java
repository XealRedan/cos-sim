...
public abstract class AbstractItem implements  IPlaceable {
	...
	protected IRenderable.FrustrumState frustrumState = IRenderable.FrustrumState.OutOfView;
	...
	public IRenderable.FrustrumState getLastFrustrumState() {
		return this.frustrumState;
	}

	@Override
	public void checkFrustum() {
		this.frustrumState = IRenderable.FrustrumState.InView;
	}
