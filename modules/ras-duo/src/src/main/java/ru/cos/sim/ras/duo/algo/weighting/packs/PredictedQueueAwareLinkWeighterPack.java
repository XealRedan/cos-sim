...
import sim.ras.duo.helper.RegularTrafficLightsCalculator;
...
public class PredictedQueueAwareLinkWeighterPack extends WeighterPack implements StandardWeightProvider.LinkWeighterPack, StandardWeightProvider.LinkReportingPack {
	public PredictedQueueAwareLinkWeighterPack(Solution solution, StandardWeightProvider.LinkWeighterPack base, WeightProvider travelTimeWeightProvider) {
		super(solution);
		this.base = base;
		this.travelTimeWeightProvider = travelTimeWeightProvider;
	}
	
	private StandardWeightProvider.LinkWeighterPack base;
